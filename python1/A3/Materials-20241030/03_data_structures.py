...
# You can create a set via curly braces {}. Empty sets must be created with the
# built-in magic "set" (empty curly braces would create an empty dictionary, see
# further below).
empty_set = set()
...
# value must be an iterable but can have an arbitrary length). This is an
